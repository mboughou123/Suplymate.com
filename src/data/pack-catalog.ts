...
export type PackSupplier = Supplier & {
  ...
  packSlug: string;
  /** Source pack: `phase1` | `daily-2026-09-02` | `daily-2026-09-03` | `daily-2026-09-10` | `hold30-2026-09-10` | `daily-2026-09-11` | `daily-2026-09-11-skip12` | `daily-2026-09-11-rest30` | `daily-2026-09-14` | `daily-2026-09-14-hold22` | `daily-2026-09-14-hold33`. */
  pack: string;
