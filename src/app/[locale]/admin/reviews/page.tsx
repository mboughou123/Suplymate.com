...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildLocalizedPageMetadata({ locale, pathname: "/admin/reviews", titleKey: "adminReviewsTitle", descriptionKey: "adminDescription", robots: { index: false, follow: false } });
}
