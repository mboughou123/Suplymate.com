...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildLocalizedPageMetadata({ locale, pathname: "/admin/audit", titleKey: "adminAuditTitle", descriptionKey: "adminDescription", robots: { index: false, follow: false } });
}
