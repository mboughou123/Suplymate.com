...
export default function FeatureCard({
  ...
  return (
    <TiltCard href={href} className="flex h-full flex-col p-6 sm:p-7">
      <span className="relative flex h-12 w-12 items-center justify-center rounded-xl border border-cyan/20 bg-gradient-to-br from-cyan/10 to-teal/10 text-cyan shadow-sm transition-transform duration-300 group-hover:scale-110 group-hover:border-cyan/35 group-hover:shadow-glow">
      ...
      <span className="relative mt-5 inline-flex items-center gap-1.5 text-sm font-semibold text-cyan transition-all group-hover:gap-2.5">
