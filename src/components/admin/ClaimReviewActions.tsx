...
export default function ClaimReviewActions({ claimId }: { claimId: string }) {
  ...
  return (
    <div className="mt-3 flex flex-wrap items-center gap-2">
      ...
      <button type="button" disabled={busy} onClick={() => act("NEEDS_INFORMATION")} className="rounded-lg bg-cyan-soft0 px-3 py-1.5 text-xs font-semibold text-white hover:bg-[#075985] disabled:opacity-60">
        Needs info
      </button>
