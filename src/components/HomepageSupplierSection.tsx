...
function toCardProps(s: Supplier): HomepageSupplierCardProps {
  ...
  return {
    ...
    hasRealRating: d.hasRealRating,
    hasRealReviews: d.hasRealReviews,
    verified: d.verified && !d.likelyTrader,
    likelyTrader: d.likelyTrader,
    businessTypeLabel: d.businessTypeLabel,
    description,
    coverImage: d.factoryPhotoUrl,
    coverFallback: getSupplierFallbackImage(s.category ?? s.industry, d.name),
    logoUrl: d.logoUrl,
    logoInitials: d.logoText,
    logoGradient: d.logoGradient,
    logoDarkChip: d.logoDarkChip,
    href: `/supplier/${d.id}`,
  };
}
