...
import rawDaily from "../../data/daily-2026-09-07-suppliers.json";
import type { Industry, Supplier, SupplierCategory } from "@/data/suppliers";
import { dailySupplierIdForSlug20260907 } from "@/lib/daily-2026-09-07-ids";
...
function buildDailySuppliers(): Supplier[] {
  ...
  return items.map((mill) => {
    ...
    return {
      id: dailySupplierIdForSlug20260907(mill.slug),
...
export const daily20260907Suppliers: Supplier[] = buildDailySuppliers();
