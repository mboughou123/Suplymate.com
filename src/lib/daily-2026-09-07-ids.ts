/**
 * Daily 2026-09-07 mill ids — full 50/50 pack (no remaining HOLD).
...
/** Remaining researcher HOLD / blocked — empty; full 50/50 pack is wired. */
export const DAILY_20260907_HOLD_SLUGS = [] as const;
