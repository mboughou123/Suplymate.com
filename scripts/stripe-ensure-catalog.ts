...
> = {
  basic: {
    ...
    description: "Homepage, supplier browse, messaging, and 1 demo Mate run. 3-day trial.",
    lookupKey: "suplymate_basic_monthly",
    productLookup: "suplymate_basic",
  },
  premium: {
    name: "Suplymate Premium",
    description: "10× Mate usage, live materials price tracking, team seats. 3-day trial.",
    lookupKey: "suplymate_premium_monthly",
    productLookup: "suplymate_premium",
  },
  enterprise: {
    name: "Suplymate Enterprise",
    description: "100 seats, team workflows, unlimited Mate after subscribe. 3-day trial.",
